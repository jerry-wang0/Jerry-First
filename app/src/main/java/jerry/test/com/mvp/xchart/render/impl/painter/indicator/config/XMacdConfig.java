...
/**
 * Created by Jingqi Xu on 9/11/15.
 */
public class XMacdConfig extends AbstractXConfig implements Copyable<XMacdConfig> {
    //
    private int color;
    private String name;
    ...
    public XMacdConfig(int order) {
        super(IndicatorType.MACD, order); reset();
    }
     ...
     */
    @Override
    public XMacdConfig copy() {
        XMacdConfig r = new XMacdConfig();
        super.copy(this, r);
        r.name = this.name;
        r.color = this.color;
    ...
    @Override
    public void reset() {
        this.periods[0] = 12; this.periods[1] = 26; this.periods[2] = 9;
        this.visibilities[0] = true; this.visibilities[1] = true; this.visibilities[2] = true;
        this.color = Color.WHITE; this.colors[0] = Color.RED; this.colors[1] = Color.RED; this.colors[2] = Color.GREEN;
    }
}
