 ...
 */
public class XEmaConfig extends AbstractXConfig implements Copyable<XEmaConfig> {
    //
    private int color;
    private String name;
    ...
    public XEmaConfig(int order) {
        super(IndicatorType.EMA, order); reset();
    }
     ...
     */
    @Override
    public XEmaConfig copy() {
        XEmaConfig r = new XEmaConfig();
        super.copy(this, r);
        r.name = this.name;
        r.color = this.color;
    ...
    @Override
    public void reset() {
        this.periods[0] = 7; this.periods[1] = 13; this.periods[2] = 25;
